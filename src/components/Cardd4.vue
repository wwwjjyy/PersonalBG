<template>
    <CardContainer>
        <CardBody
            ...
            <CardItem :translate-z="100" class="mt-4  w-full h-full">
                <img src="@/assets/jingli/uni.png" height="500" width="500"
                    class="h-60 w-30 mx-auto rounded-xl object-cover group-hover/card:shadow-xl" alt="thumbnail" />
            </CardItem>
            <div class="mt-20 flex items-center justify-between">
                ...
                <CardItem :translate-z="20" as="a" href="https://github.com/wwwjjyy/FACE"
                class="rounded-xl px-4 py-2 text-xs font-normal dark:text-white">
                    GitCode →
                </CardItem>
            </div>
